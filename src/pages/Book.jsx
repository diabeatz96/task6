            ...
            {!error && !loading &&
                <>
                    <section className= "grid min-w-full border solid border-4 bg-gradient-to-r from-rose-100 to-teal-100 " >
                        ...
                        <Link className=" m-2 absolute inline-block rounded-full border border-indigo-600 bg-white p-3 text-indigo-500 hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500"
                           to="/books"
                        >
                        ...
                        <div className="  text-center  ">
                            <h2 className= " text-5xl p-5 font-black"> {!bookData ? "Loading" : bookData.title} </h2>
                            <h3 className= " text-lg p-5 font-bold"> {!bookData ? "Loading" : ` ✍️ Written by: ${bookData.author} 📚 Published by: ${bookData.publisher}`} </h3>
                        </div>

                        <div>
                            <img  alt = {!bookData ? "" : bookData.imageURL} className=" my-4 mx-auto " src={!bookData ? "" : bookData.imageURL}/>
                        </div>
